...
export function About() {
  ...
  const defaultInfo = {
    ...
    experienceCards: [{"icon":"briefcase","title":"한국토지주택공사","period":"2020 - 현재","description":"직무 및 역할"},{"icon":"graduation","title":"단국대학교 부동산 건설대학원","period":"2024 - 현재","description":"도시 및 부동산개발"},{"icon":"award","title":"자격증/수상","period":"2021","description":"설명을 입력하세요"}],
